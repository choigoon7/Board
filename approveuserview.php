...
<body>	
 ...
 <form action="approvemodify.php?number=<?=$array[NO]?>&userid=<?=$userid?>" method="post" data-ajax="false">
...
<table border=0 cellspacing=1 cellpadding=0 bgcolor="white">
        ...
        <tr>
          ...
          <td colspan="3">
						...
						<a  data-ajax="false"  href="download.php?no=<?=$array[NO]?> &userid=<?=$userid?>"> <? echo "$array[FILENAME]"; ?></a> 
...
if( trim($userid) == trim($array[WRITER]) )
{
	echo' 
				 <tr>
  				<td align=right>
